...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Liste des archives')); ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 divide-x divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="<?php echo e($loop->even ? 'bg-gray-50' : 'bg-white'); ?> hover:bg-blue-50 transition-colors divide-x divide-gray-200">
                                <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($archive->id_archive); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($archive->num_serie); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($archive->description); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($archive->date_archivage); ?></td>
                                <td class="px-6 py-4 text-sm text-center">
                                    <a href="<?php echo e(route('archive.edit', $archive->id_archive)); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\Asus Laptop\Documents\Vs Code\Gestion_parc_informatique\resources\views/archive/index.blade.php ENDPATH**/ ?>