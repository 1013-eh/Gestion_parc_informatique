<?php $__env->startSection('title', 'Modifier un centre'); ?>
<?php $__env->startSection('page-title', '✏️ Modifier un centre'); ?>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h2 class="text-xl font-semibold text-gray-800 mb-6">
                    <i class="fas fa-edit text-yellow-600 mr-2"></i> Modifier le centre : <?php echo e($centre->code_bureau); ?>
                ...
                <form action="<?php echo e(route('centres.update', $centre->code_bureau)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('code_bureau', $centre->code_bureau)); ?>"
                                   required>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('nom_centre', $centre->nom_centre)); ?>"
                                   required>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($region->id_region); ?>" <?php echo e(old('id_region', $centre->id_region) == $region->id_region ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user->matricule); ?>" <?php echo e(old('matricule', $centre->matricule) == $user->matricule ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('adresse_ip', $centre->adresse_ip)); ?>"
                                   required>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="GLOBAL" <?php echo e(old('type_consultation', $centre->type_consultation) == 'GLOBAL' ? 'selected' : ''); ?>>🌍 Consultation globale</option>
                                <option value="PAR_CENTRE" <?php echo e(old('type_consultation', $centre->type_consultation) == 'PAR_CENTRE' ? 'selected' : ''); ?>>🏢 Consultation par centre</option>
                                <option value="ADMIN" <?php echo e(old('type_consultation', $centre->type_consultation) == 'ADMIN' ? 'selected' : ''); ?>>🔒 Administrateur</option>
                            </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Gestion_parc_informatique\resources\views/centres/edit.blade.php ENDPATH**/ ?>