...
@section('page-title', '✏️ Modifier une région')
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h2 class="text-xl font-semibold text-gray-800 mb-6">
                    <i class="fas fa-edit text-yellow-600 mr-2"></i> Modifier : {{ $region->libelle_region }}
                </h2>
                ...
                <form action="{{ route('regions.update', $region->id_region) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('libelle_region', $region->libelle_region) }}"
                               required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('abreviation', $region->abreviation) }}"
                               maxlength="5"
                               required>
